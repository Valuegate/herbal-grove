...
export const ForgotPassword = () => {
  return (
    <main className="w-full min-h-screen flex items-center justify-center p-4 sm:p-8 lg:p-12 bg-cover bg-center bg-no-repeat relative" style={{ backgroundImage: `url(${bgImage.src})` }}>
      {/* Back to Home Button */}
      <Link
        href="/">
        <button 
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-center w-full max-w-[900px] mx-auto mt-6">
        {/* Left Card - Branding */}
