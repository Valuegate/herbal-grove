  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-center w-full max-w-[1000px] gap-8 lg:gap-0">
        ...
        <div className="relative lg:z-10 w-full lg:w-[520px] rounded-[2rem] shadow-2xl overflow-hidden bg-white/95 border border-gray-100 backdrop-blur-sm p-8 lg:p-10">
          <SignUpForm />
        </div>
      </div>
    </main>
